...
import type { ContactForm as _ContactForm } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllInquiries(): Promise<Array<ContactForm>> {
        if (this.processError) {
            try {
    ...
    async getInquiryById(arg0: bigint): Promise<ContactForm | null> {
        if (this.processError) {
            try {
    ...
    async updateInquiry(arg0: bigint, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateInquiry(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContactForm]): ContactForm | null {
